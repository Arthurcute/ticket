...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($input['conversationId']) || empty($input['adminId']) || empty($input['messageContent'])|| empty($input['encrypted_aes_key'])|| empty($input['encrypted_aes_key_admin'])) {
    ...
    $sql = "INSERT INTO messages (conversation_id, sender_type, message_content ,encrypted_aes_key , encrypted_aes_key_admin, timestamp) VALUES (?, 'admin', ?,?,?, NOW())";
